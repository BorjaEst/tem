            ...
            for location in new_locations:
                for action in location["actions"]:
                    ...
                    action["Q"] = sum(
                        [
                            probability
                            * ((new_location in reward_locations) + self.shiny["gamma"] * max([new_action["Q"] for new_action in prev_locations[new_location]["actions"]]))
                            for new_location, probability in enumerate(action["transition"])
                        ]
                    )
