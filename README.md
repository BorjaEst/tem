...
## Nomenclature change and conventions

In the original TEM paper some terminology was generating confusion. In this implementation we have made some changes to the nomenclature to make things clearer.

- o: "Observation" in the original paper refers to the sensory input, which was denoted by "x".
- c: "Compressed" representation of the observation, denoted by "x_c" in the original paper.
- x: "Feature" representation, denoted by "x_f" in the original paper. We decided to use 'x' to represent it as the feature cells that lie in the LEC.
